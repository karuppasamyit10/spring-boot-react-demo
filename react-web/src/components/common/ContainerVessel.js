...
class ContainerVessel extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
      ...
      <React.Fragment>
        ...
        <div class="row no-gutters">
          <div class="col-12 text-center">
            ...
            <p class="para1 mt-2">
              The shoring service is to stuff the items into the container and
              fix it. Let's show to do shoring of containers.
            </p>
          </div>
          <div class="col-12">
            <iframe
              width="100%"
              height="400"
              src="https://www.youtube.com/embed/EE-CITExdDE"
              frameborder="0"
        ...
        <div class="row mt-3">
          <div class="col-12">
            <ul
              class="nav nav-tabs transporttabs nav-fill"
              id="myTab"
              role="tablist"
            >
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a
                  class="nav-link"
                  id="equipmentwheel-tab"
                  data-toggle="tab"
                  href="#equipmentwheel"
                  role="tab"
                  aria-controls="equipmentwheel"
                  aria-selected="false"
                >
                  Equipment (Wheel)
                </a>
              ...
              <li class="nav-item">
                <a
                  class="nav-link"
                  id="equipmentcater-tab"
                  data-toggle="tab"
                  href="#equipmentcater"
                  role="tab"
                  aria-controls="equipmentcater"
                  aria-selected="false"
                >
            ...
            <div class="tab-content" id="myTabContent">
              ...
              >
                <div class="row no-gutters">
                  <div class="col-6">
                    <img
                      src={require("../../assets/img/about/what-we-do/acc05.jpg")}
                      class="img-fluid w-100"
                      alt=""
                    />
                  </div>
                  <div class="col-6">
                    <img
                      src={require("../../assets/img/about/what-we-do/acc06.jpg")}
                      class="img-fluid w-100"
                      alt=""
                    />
                  </div>
                  <div class="col-6">
                    <img
                      src={require("../../assets/img/about/what-we-do/acc07.jpg")}
                      class="img-fluid w-100"
                      alt=""
                    />
                  </div>
                  <div class="col-6">
                    <img
                      src={require("../../assets/img/about/what-we-do/acc08.jpg")}
                      class="img-fluid w-100"
                      alt=""
                    />
                  </div>
              ...
              <div
                ...
                id="equipmentwheel"
                role="tabpanel"
                aria-labelledby="equipmentwheel-tab"
              >
                <div class="row no-gutters">
                  <div class="col-6">
                    <img
              ...
              <div
                ...
                id="equipmentcater"
                role="tabpanel"
                aria-labelledby="equipmentcater-tab"
              >
                <div class="row no-gutters">
                  <div class="col-6">
                    <img
        ...
        <div class="row no-gutters">
          <div class="col-12 text-center">
            <div class="head2 bold green ">
              No. of items to be put into container
            </div>
          </div>
...
export default ContainerVessel;
